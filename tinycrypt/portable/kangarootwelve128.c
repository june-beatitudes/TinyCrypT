...
void
tct_turboshake128_absorb (uint8_t state[TCT_TURBOSHAKE128_STATE_LEN], const uint8_t *data,
...
void
tct_turboshake128_squeeze_destructive (uint8_t state[TCT_TURBOSHAKE128_STATE_LEN], uint8_t *output,
